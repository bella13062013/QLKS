...
namespace Hotel_N3
{
    public partial class Form1 : Form
    {
        ...
        private void btndangnhap_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("Select chucvu from dangnhap Where tendangnhap " +
                "='" + txtuser.Text + "' and matkhau ='" + txtpass.Text + "'",con);
            DataTable dt = new System.Data.DataTable();
            sda.Fill(dt);
            if(dt.Rows.Count == 1)
            {
                this.Hide();
                MDIParent2 ss = new MDIParent2(dt.Rows[0][0].ToString());
                ss.Show();
